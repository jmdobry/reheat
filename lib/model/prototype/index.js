...
module.exports = {
	...
	escape: function (key) {
		if (!utils.isString(key)) {
			throw new errors.IllegalArgumentError('Model#escapeHtml(key): key: Must be a string!');
		}
		try {
	...
	get: function (key) {
		if (!utils.isString(key)) {
			throw new errors.IllegalArgumentError('Model#get(key): key: Must be a string!');
		}
		try {
	...
	has: function (key) {
		if (!utils.isString(key)) {
			throw new errors.IllegalArgumentError('Model#has(key): key: Must be a string!');
		}
		try {
	...
	hasOwn: function (key) {
		if (!utils.isString(key)) {
			throw new errors.IllegalArgumentError('Model#hasOwn(key): key: Must be a string!');
		}
		try {
