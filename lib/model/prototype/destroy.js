    ...
    return Promise.resolve().bind(this)
      ...
      .then(function (Model) {
        if (Model.softDelete) {
          ...
          return Model.connection.run(Model.r.table(Model.tableName).get(this.get(Model.idAttribute) || '').update(this.attributes, { returnVals: true }), options);
        } else {
          return Model.connection.run(Model.r.table(Model.tableName).get(this.get(Model.idAttribute) || '').delete(), options);
        }
      })
