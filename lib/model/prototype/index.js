module.exports = function (container, utils, errors) {
	return {
		...
		set: container.resolve(require('./set')),

		// See reheat/lib/model/prototype/setSync.js
		setSync: container.resolve(require('./setSync')),

		// See reheat/lib/model/prototype/unset.js
		unset: container.resolve(require('./unset')),

		// See reheat/lib/model/prototype/clear.js
		clear: container.resolve(require('./clear')),

		// See reheat/lib/model/prototype/save.js
		save: container.resolve(require('./save')),

		// See reheat/lib/model/prototype/destroy.js
		destroy: container.resolve(require('./destroy')),
