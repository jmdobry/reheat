module.exports = function (utils, Model_get, Model_prototype, Collection_filter, Collection_getAll) {
	...
	Model.get = Model_get;
	Model.filter = Collection_filter;
	Model.getAll = Collection_getAll;
