...
container.resolve(function (r, Promise, robocop, utils, errors, extend, Model, Collection, Connection, models, collections) {
	...
	reheat.defineCollection = function (name, staticProps, protoProps) {
		...
		} else if (!(staticProps.model.constructor.__reheat_super__)) {
			throw new errors.IllegalArgumentError(errorPrefix2 + 'staticProps.model: Must be an instance of a subclass of Model!', { model: { actual: typeof staticProps.model, expected: 'subclass of Model' } });
		} else {
